                    ...
                    <form class="needs-validation">
                        <div class="row g-4">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" name="name" id="fname" placeholder="Enter Your Name">
                            </div>
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control" name="rrnf" id="fnum" >
                            </div>
                            ...
                            <div class="col">
                                ...
                                <input type="password" class="form-control" name="rrnl" id="fnum" >
                            </div>
                            </div>
                            <!-- 가입자 주소  -->
                            <div class="row mt-2">
	    ...
	    new daum.Postcode({
	        oncomplete: function(data) {
	            ...
	            if (data.userSelectedType === 'R') { // 사용자가 도로명 주소를 선택했을 경우
	                ...
	                /* var txt_addr = $('.txt_addr').html();	// 도로명주소
		            var txt_postcode = $('.txt_postcode').html();	// 우편번호
		            
		            console.log(txt_addr);
		            console.log(txt_postcode); */
