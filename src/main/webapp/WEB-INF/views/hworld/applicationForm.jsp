    ...
    <section class="section-b-space">
        ...
        <div class="container" style="padding: 0px 130px;">
            <div class="row g-4">
                <!-- 좌측영역 -->
                <div class="col-lg-7">
                    <form class="needs-validation" id="appForm" action="./application" method="POST">
                        <div class="row g-4">
                            <!-- 가입자 정보 시작 -->
                                ...
                                <!-- 신규가입 폰 번호 -->
                                    ...
                                    <div class="d-flex col-md-12">
                                        ...
                                        <div class="col-md-6 mt-3 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="directCode" name="directCode" placeholder="ex)P01BSCB128G2301">
                                        </div> 
                                    </div>   
                                </div>    
